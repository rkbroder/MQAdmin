...
function showSound(){
        ...
        var message = '<APPLET code="HotAudioLite.class" archive="hotaudio.zip" name="About the Menu" width=250 height=50  MAYSCRIPT><PARAM NAME="cabbase" VALUE="hotaudio.cab"><Param name="src" value="media/DLAU02.hal"><Param name="autostart" value ="True"><Param name="bkcolor" value="9900cd"><Param name="showslider" value ="True"><Param name="showplay" value="True"><Param name="showstop" value ="True"></applet>';
		if(is.ns4) {
