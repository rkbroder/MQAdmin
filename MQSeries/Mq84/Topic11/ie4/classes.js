...
return value; } function _nq(id,_e,children,_f,_g,_h,_jb){ this._i=_kb; this._i(id,_e,children,_f,_g,_h,_jb);
this._k[this._k.length]='_nq'; } function _bf(id,_e,children,_f,_g,_h,left,top,width,height,_jb){
this._i=_kb; this._i(id,_e,children,_f,_g,_h,_jb); this._k[this._k.length]='_bf';
this.left=left; this.top=top; this.width=width; this.height=height; this._cf=_df;
} function _df(_He){ var a=this.width/2; var b=this.height/2; var m=this.left+a;
...
_ki(_bd,event,_jb); } } var _Mh="ie4"; var _Nh=600; var _Oh=800; var _Lh=""; var _mh="MQ84 - MQSeries System Administration - Security";
