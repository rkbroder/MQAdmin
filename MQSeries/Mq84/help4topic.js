...
function layerSetup() {
	...
	scr24Lyr = eval(doc + '["scr22Layer"]' + sty);
	scr24Lyr.left = parseInt(bluepanelLyr.left)-15;
	scr24Lyr.top = 50;

	scr25Lyr = eval(doc + '["scr24Layer"]' + sty);
	...
	balloon1Lyr.left = parseInt(bluepanelLyr.left)+240;
	balloon1Lyr.top = parseInt(bluepanelLyr.top)+250;

	balloon2Lyr = eval(doc + '["balloon2Layer"]' + sty);
	balloon2Lyr.left = parseInt(bluepanelLyr.left)+185;
	balloon2Lyr.top = parseInt(bluepanelLyr.top)+240;

	balloon3Lyr = eval(doc + '["balloon3Layer"]' + sty);
	balloon3Lyr.left = parseInt(bluepanelLyr.left)+185;
	balloon3Lyr.top = parseInt(bluepanelLyr.top)+240;

	balloon4Lyr = eval(doc + '["balloon4Layer"]' + sty);
	balloon4Lyr.left = parseInt(bluepanelLyr.left)+190;
	balloon4Lyr.top = parseInt(bluepanelLyr.top)+250;

	balloon5Lyr = eval(doc + '["balloon5Layer"]' + sty);
	balloon5Lyr.left = parseInt(bluepanelLyr.left)+25;
	...
	balloon10Lyr.left = parseInt(bluepanelLyr.left)+10;
	balloon10Lyr.top = parseInt(bluepanelLyr.top)+110;

	balloon11Lyr = eval(doc + '["balloon11Layer"]' + sty);
	balloon11Lyr.left = parseInt(bluepanelLyr.left)+25;
	...
	balloon12Lyr.top = parseInt(bluepanelLyr.top)+80;

	balloon13Lyr = eval(doc + '["balloon13Layer"]' + sty);
	balloon13Lyr.left = parseInt(bluepanelLyr.left)+40;
	balloon13Lyr.top = parseInt(bluepanelLyr.top)+220;

	balloon14Lyr = eval(doc + '["balloon14Layer"]' + sty);
	balloon14Lyr.left = parseInt(bluepanelLyr.left)+120;
	balloon14Lyr.top = parseInt(bluepanelLyr.top)+175;

	balloon15Lyr = eval(doc + '["balloon15Layer"]' + sty);
	balloon15Lyr.left = parseInt(bluepanelLyr.left)+210;
	balloon15Lyr.top = parseInt(bluepanelLyr.top)+180;

	balloon16Lyr = eval(doc + '["balloon16Layer"]' + sty);
	balloon16Lyr.left = parseInt(bluepanelLyr.left)+250;
	balloon16Lyr.top = parseInt(bluepanelLyr.top)+35;

	balloon17Lyr = eval(doc + '["balloon17Layer"]' + sty);
	balloon17Lyr.left = parseInt(bluepanelLyr.left)+200;
	balloon17Lyr.top = parseInt(bluepanelLyr.top)+200;

	balloon18Lyr = eval(doc + '["balloon18Layer"]' + sty);
	balloon18Lyr.left = parseInt(bluepanelLyr.left)+185;
	balloon18Lyr.top = parseInt(bluepanelLyr.top)+30;
	...
	balloon20Lyr.left = parseInt(bluepanelLyr.left)+50;
	balloon20Lyr.top = parseInt(bluepanelLyr.top)+210;

	balloon21Lyr = eval(doc + '["balloon21Layer"]' + sty);
	balloon21Lyr.left = parseInt(bluepanelLyr.left)+80;
	balloon21Lyr.top = parseInt(bluepanelLyr.top)+200;

	balloon22Lyr = eval(doc + '["balloon22Layer"]' + sty);
	balloon22Lyr.left = parseInt(bluepanelLyr.left)+35;
	balloon22Lyr.top = parseInt(bluepanelLyr.top)+170;

	balloon23Lyr = eval(doc + '["balloon23Layer"]' + sty);
	balloon23Lyr.left = parseInt(bluepanelLyr.left)+35;
	balloon23Lyr.top = parseInt(bluepanelLyr.top)+170;

	balloon24Lyr = eval(doc + '["balloon24Layer"]' + sty);
	balloon24Lyr.left = parseInt(bluepanelLyr.left)+35;
	balloon24Lyr.top = parseInt(bluepanelLyr.top)+170;
...
function showText3(){
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText5();"> Course objectives            </A></FONT></UL>';
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText6();">  Course prerequisites       </A></FONT></UL>';
      message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="100"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText7();">  Course content       </A></FONT></UL>';
      message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="100"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText9();">  Curriculum map       </A></FONT></UL>';
      message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="100"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText11();">  Troubleshooting </A></FONT></UL>';
      message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="100"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
...
function showText4(){
        ...
        var thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="counter3 = 0; how2Menu();"> Use the course menu </A></font></UL>';
        ...
        thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="counter2 = 0; how2Glos();"> Use the glossary </A></font></UL>';
        ...
        thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="counter = 0; slides();"> Use the courseware </A></font></UL>';
        message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="250" HEIGHT="300"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
        ...
        thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText10();"> Access the labs </A></font></UL>';
        var message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="250" HEIGHT="300"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
        ...
        thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="counter4 = 0; how2Transcript();"> Access the Transcript </A></font></UL>';
        message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="250" HEIGHT="300"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
        ...
        thelist = '<UL><font class=buttons><LI><A href="javascript:void(null)" onclick="showText8();"> Track your progress </A></font></UL>';
        message = '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="250" HEIGHT="300"><TR><TD VALIGN=TOP>' + thelist + '</FONT></TD></TR></TABLE>';
		if(is.ns4) {
...
function how2Transcript(){
   ...
   if(counter4==0) {
       ...
       counter4 ++;
        ...
        thelist = "Concepts and procedures in each topic have clear diagrams and spoken explanations. If you wish, you can see a transcript of the audio in a second browser window. Click the 'text for audio' button on the first page to enable the text window.<BR>You will only need to do this once and the window will be there for the whole topic.";
       ...
       setTimeout("how2Transcript()",20000);
       }
       else if(counter4==1) {
